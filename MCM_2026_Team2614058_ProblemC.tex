...
\noindent\textbf{Background:} In the era of entertainment big data, voting mechanisms of competitive reality shows have become a critical research area intersecting data science and social behavior analysis. \textit{Dancing with the Stars} (DWTS), as one of the most influential dance reality shows in the United States, has operated for 34 seasons with 421 celebrity contestants. The dual-track evaluation system combining judge scores and fan votes directly impacts competition fairness. However, strict confidentiality of fan voting data poses significant research challenges. This study addresses four core problems: mining hidden voting patterns, evaluating aggregation methods, identifying key influencing factors, and designing fairer voting systems.
